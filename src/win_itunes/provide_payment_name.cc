...
namespace win_itunes{
	...
	std::string GenerateChinaName::GenerateFirstName()
	{
		...
		if ((sex % 2) == 0)
		{
			...
			firstName = Strings::SplitArray(totleGName, ",");
		}
		else
		{
			//generate boyFirstName
			firstName = Strings::SplitArray(totleBName, ",");
		}

		int temp = rand() % firstName.size();
