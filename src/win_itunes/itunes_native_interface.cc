...
namespace win_itunes{
	namespace internal{
		...
		std::wstring GetITunesInstallDll(const std::wstring dll_name){
			const std::wstring dll = GetDirectory().append(L"iTunesCore.dll");
			//date:2015/09/06
	...
	void iTunesNativeInterface::Init(){
		...
		Loads();
		const std::wstring itunes_dll = loads_itunes_;
		...
		if(iTunesDllVersion(L"10.5.0.142")){
			...
			iTunesDllVersion(L"12.1.2.27")){
				if(!IsMachineAmd64(L"iTunesCore.dll",internal::GetITunesInstallDll(L"").c_str())){
					Kbsync = 0x2D900u;
					KbsyncID = 0x16880u;
					CigHash = 0x10630u;
					WriteSIDD = 0x1B710u;
		...
		else if (iTunesDllVersion(L"12.3.0.44") || iTunesDllVersion(L"12.3.1.23") || iTunesDllVersion(L"12.3.2.35")){
			Kbsync = 0x1CF80u;
			KbsyncID = 0xABA50u;
			CigHash = 0xACD0u;
			WriteSIDD = 0x35EA0u;
			...
			if (iTunesDllVersion(L"12.3.1.23")){
				GetCltDat = 723312;
				TranSetInf = 883056;
				GetMD = 887424;
			}
			else if (iTunesDllVersion(L"12.3.2.35")){
				GetCltDat = 885936;
				TranSetInf = 883056;
				GetMD = 887424;
			}
		...
		else if (iTunesDllVersion(L"12.3.3.17")){
			Kbsync = 704240;
			KbsyncID = 296416;
			CigHash = 42960;
			WriteSIDD = 391600;
			...
			CalcUnkP1 = 445520;
			SetAFSyncRQ = 714640;
			PreAuthByDSID = 101824;
			VerifyAFSyncRQ = 450000;
			GenerateAFSyncRS = 20560;
			GetCltDat = 894128;
			TranSetInf = 891248;
			GetMD = 895616;
			std::uint32_t GetMDCreate = 898576;
			SapInit = 4096;
			SapGetP1 = 200144;
			SapCalcBuffer = 90992;
			SapGetAS = 16160;
			SapGetASFD = 522512;
			SapGetASFD_a = 108288;
			std::uint32_t AppleIDAuthSupportCreate = 19628368;
			std::uint32_t stateClientNeg1 = 19631152;
			std::uint32_t stateClientNeg2 = 19632640;
			std::uint32_t stateClientNeg3 = 19633856;
			std::uint32_t AuthMidOtp = 893536;
			const wchar_t* http_ua = L"iTunes/12.3.3 (Windows; Microsoft Windows 7 Ultimate Edition Service Pack 1 (Build 7601)) AppleWebKit/7601.1056.1.1";
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnAuthMidOtp) = reinterpret_cast<unsigned long>(itunes_base)+AuthMidOtp;
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnGetMDCreate) = reinterpret_cast<unsigned long>(itunes_base)+GetMDCreate;
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnAppleIDAuthSupportCreate) = reinterpret_cast<unsigned long>(itunes_base)+AppleIDAuthSupportCreate;
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnstateClientNeg1) = reinterpret_cast<unsigned long>(itunes_base)+stateClientNeg1;
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnstateClientNeg2) = reinterpret_cast<unsigned long>(itunes_base)+stateClientNeg2;
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnstateClientNeg3) = reinterpret_cast<unsigned long>(itunes_base)+stateClientNeg3;
			iTunesInternalInterface::Instance()->lpfnClientNeg3OffSet = 32;
		}
		else if (iTunesDllVersion(L"12.4.0.119")){
			Kbsync = 489760;
			KbsyncID = 117584;
			CigHash = 227024;
			WriteSIDD = 593808;
			...
			CalcUnkP1 = 647728;
			SetAFSyncRQ = 500160;
			PreAuthByDSID = 285888;
			VerifyAFSyncRQ = 652208;
			GenerateAFSyncRS = 204624;
			GetCltDat = 894128;
			TranSetInf = 891248;
			GetMD = 895616;
			SapInit = 188160;
			SapGetP1 = 21312;
			SapCalcBuffer = 275056;
			SapGetAS = 200224;
			SapGetASFD = 724720;
			SapGetASFD_a = 292352;
			const wchar_t* http_ua = L"iTunes/12.4.0 (Windows; Microsoft Windows 7 Ultimate Edition Service Pack 1 (Build 7601)) AppleWebKit/7601.1056.1.1";
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnAuthMidOtp) = reinterpret_cast<unsigned long>(itunes_base)+893536;
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnGetMDCreate) = reinterpret_cast<unsigned long>(itunes_base)+898576;
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnAppleIDAuthSupportCreate) = reinterpret_cast<unsigned long>(itunes_base)+19759600;
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnstateClientNeg1) = reinterpret_cast<unsigned long>(itunes_base)+19762400;
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnstateClientNeg2) = reinterpret_cast<unsigned long>(itunes_base)+19763888;
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnstateClientNeg3) = reinterpret_cast<unsigned long>(itunes_base)+19765104;
			iTunesInternalInterface::Instance()->lpfnClientNeg3OffSet = 32;
		}
		else if (iTunesDllVersion(L"12.4.1.6")){
			Kbsync = 489760;
			KbsyncID = 117584;
			CigHash = 227024;
			WriteSIDD = 593808;
			...
			SapGetASFD = 724720;
			SapGetASFD_a = 292352;
			const wchar_t* http_ua = L"iTunes/12.4.1 (Windows; Microsoft Windows 7 Ultimate Edition Service Pack 1 (Build 7601)) AppleWebKit/7601.1056.1.1";
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnAuthMidOtp) = reinterpret_cast<unsigned long>(itunes_base)+893536;
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnGetMDCreate) = reinterpret_cast<unsigned long>(itunes_base)+898576;
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnAppleIDAuthSupportCreate) = reinterpret_cast<unsigned long>(itunes_base)+19768784;
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnstateClientNeg1) = reinterpret_cast<unsigned long>(itunes_base)+19771568;
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnstateClientNeg2) = reinterpret_cast<unsigned long>(itunes_base)+19773056;
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnstateClientNeg3) = reinterpret_cast<unsigned long>(itunes_base)+19774272;
			iTunesInternalInterface::Instance()->lpfnClientNeg3OffSet = 32;
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnCalcSbsync) = reinterpret_cast<unsigned long>(itunes_base)+0x351B0;
      *reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnGetAppleMDParam) = reinterpret_cast<unsigned long>(itunes_base)+0x7CFA90;
		}
		else{
			Kbsync = -1;
			KbsyncID = -1;
		...
		*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnUpdCDID) = reinterpret_cast<unsigned long>(itunes_base)+UpdCDID;
		if (GetMD)
			...
			*reinterpret_cast<unsigned long*>(&iTunesInternalInterface::Instance()->lpfnGetMD) = 0;
	...
	bool iTunesNativeInterface::Loads(){
		...
		loads_itunes_.resize(0);
		loads_itunes_ = itunes_module.iTunesDll(L"iTunesCore.dll");
		HINSTANCE hITunesDll = LoadLibrary(loads_itunes_.c_str());
		if (hITunesDll == NULL){
			loads_itunes_.resize(0);
			loads_itunes_ = itunes_module.iTunesDll(L"iTunesCore.dll");
			hITunesDll = LoadLibrary(loads_itunes_.c_str());
			if (hITunesDll == NULL){
				return false;
			}
		}
		LoadLibrary(itunes_module.corefp_dll().c_str());
